const SETTINGS = {
  INVENTORY_SYSTEM: "esx_inventory", // OPTIONS: esx_inventory, ox_inventory or qbCore
  NOTIFICATION_SYSTEM: "esx", // oxLib or qbCore or esx
  DEFAULT_LANG: "en-us",
  ...
  HOTSPOT_NOTIFICATIONS: true,
  HOTSPOT_ZONE_RADIUS_MULTIPLIER: 2.0,
  FISHES: {
    fish: {
      itemName: "fish",
      type: "common",
